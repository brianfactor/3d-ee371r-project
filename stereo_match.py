...
if __name__ == '__main__':
    ...
    stereo = cv2.StereoSGBM(
        ...
        uniquenessRatio = 10,        # sensitivity of matching algorithm
        speckleWindowSize = 100,
        speckleRange = 32,           # sensitivity of filtering
        disp12MaxDiff = 1,
    ...
    disp = stereo.compute(imgL, imgR).astype(np.float32) / 16.0    # originally np.float32
...
#    print Q
    ...
    colors = cv2.cvtColor(rgbImage, cv2.COLOR_BGR2RGB)
    mask = disp > disp.min()
